...
def draw_keypoints(image, results):
    ...
    #Puntos mano izquierda conexiones.
    ...
    # Puntos mano derecha conexiones.
...
def get_keypoints(model, path):
    #Obtener keypoints de la muestra.(Retorna la secuencia de key de la muestra)
...
def insert_keypoints_sequence(df, n_sample: int, kp_seq):
    #Inserta los key de la muestra al dataframe.
    #Retorna el mismo data pero con los key de muestra.#
